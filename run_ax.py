...
from transformers import glue_processors as processors, DataProcessor, InputExample
...
from transformers.data.processors.glue import DEPRECATION_WARNING
...
def main():
    ...
    output_modes['ax'] = 'classification'
